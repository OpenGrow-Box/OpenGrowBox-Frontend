...
export const createDefaultPlantStages = () => ({
  ...
  midFlower: { 
    ...
    minHumidity: 38, maxHumidity: 52, 
    minVPD: 0.90, maxVPD: 1.70, 
    minLight: 70, maxLight: 90,
    minEC: 1.8, maxEc: 2.4,
    minPh: 5.8, maxPh: 6.2,
